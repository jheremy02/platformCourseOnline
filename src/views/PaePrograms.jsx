        ...
        <div data-theme={dark ? 'dark' : 'light'} className={dark ? 'dark' : ''}>
            <div className='bg-white dark:bg-gray-800' >
                ...
                <section
                    className="relative"
                    style={{
                        backgroundImage: "url(https://images.pexels.com/photos/159279/pylon-current-electricity-strommast-159279.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)",
                ...
                >
                    ...
                    <div className="relative grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                        <div className="mr-auto place-self-center lg:col-span-7">
                            ...
                            Eleva tu expertise con nuestros Programas de Especialización. Diseñados para profesionales.
                            </h1>
                    ...
                    <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
                        <div className="card  bg-base-100   shadow-xl transform transition-transform duration-300 hover:scale-105">
                            ...
                            <div className="card-body p-5">
                                <h2 className="card-title text-base">Programa de Especialización Diseño de subestaciones de distribución</h2>
                                <p className='text-xs text-gray-500  dark:text-gray-400'>
                                    Aprende los fundamentos del análisis de fallas en los sistemas de potencia para la correcta interpretación de registros oscilográficos y la adecuada elaboración de informes de eventos en los sistemas eléctricos de potencia.
                        ...
                        <div className="card  bg-base-100   shadow-xl transform transition-transform duration-300 hover:scale-105">
                            ...
                            <div className="card-body p-5">
                                <h2 className="card-title text-base">Programa de Especialización Diseño de fundaciones de subestaciones y líneas de transmisión</h2>
                                <p className='text-xs text-gray-500  dark:text-gray-400'>
                                    Aprende los fundamentos del análisis de fallas en los sistemas de potencia para la correcta interpretación de registros oscilográficos y la adecuada elaboración de informes de eventos en los sistemas eléctricos de potencia.
                        ...
                        <div className="card  bg-base-100   shadow-xl transform transition-transform duration-300 hover:scale-105">
                            ...
                            <div className="card-body p-5">
                                <h2 className="card-title text-base">Programa de Especialización Análisis de fallas en sistemas eléctricos de potencia</h2>
                                <p className='text-xs text-gray-500  dark:text-gray-400'>
                                    Aprende los fundamentos del análisis de fallas en los sistemas de potencia para la correcta interpretación de registros oscilográficos y la adecuada elaboración de informes de eventos en los sistemas eléctricos de potencia.
